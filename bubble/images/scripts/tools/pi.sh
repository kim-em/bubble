...
# Install the Pi coding agent (badlogic/pi-mono; requires Node.js).
# Versions and checksums are injected as environment variables by bubble:
#   NODE_VERSION, NODE_SHA256_X64, NODE_SHA256_ARM64, PI_VERSION
...
echo "Pi installed: $(pi --version 2>/dev/null || echo 'unknown version')"
